...
if(empty($name) || empty($phone) || empty($applyTime)){
    ...
    $selectSql = "select * from zhongtie_user_info where user_phone= :user_phone;";
    ...
    if(count($count) > 0){
        ...
        $insertSql = "insert into zhongtie_user_info (user_name,user_phone,applyTime)values(:user_name, :user_phone, :applyTime)";
